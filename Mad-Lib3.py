...
carry_on = input(f"{name}, Do you want to continue?...yes or no...").lower()
...
while carry_on == "yes":
  ...
  if carry_on == "yes":
    ...
    carry_on2 = input(f"{name}, do you want to continue with this process to find another statement that might make more sense?....yes or no.....").lower()

    if carry_on2 == "no":

      print(f"{name}, I hope that you had a great experience with our service!! I think that you have passed our initial inquiry and you have been selected to continue in our selection process!")
